        ...
        {(Results && Results.length) ?
          <div className="click-table">
            <div className="mb-2 text-right">
              <CButton to={`/admin/package/${this.props.PackageId}/price-policy/${Results[0].PolicyCode}/view`} type="button" color="info">Xem chi tiết giá gói</CButton>
            </div>
            <DataTable
          ...
          <div>
            ...
            <CButton to={'/admin/price-policy/' + this.props.PackageId + '/form/new'} className="float-right" type="button" color="info">Thiết lập giá gói</CButton>
          </div>
        }
      </>
    )
